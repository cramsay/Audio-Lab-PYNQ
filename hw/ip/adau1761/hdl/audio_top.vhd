...
----------------------------------------------------------------------------------
--
-- Changes made by cramsay:
--
--  * Convert port names to infer AXI-Stream ports in Vivado
--  * Remove I2C controller (we're using the I2C core in the PS)
--
----------------------------------------------------------------------------------
...
entity audio_top is
    Port ( clk_100      : in    STD_LOGIC;                      -- 100 mhz input clock from top level logic
           ...
           AXIS_hphone_tdata    : in STD_LOGIC_VECTOR(47 downto 0);
           AXIS_hphone_tvalid   : in STD_LOGIC;

           AXIS_line_in_tdata   : out STD_LOGIC_VECTOR(47 downto 0);
           AXIS_line_in_tvalid  : out STD_LOGIC
           );
end audio_top;
...
begin
   ...
   i_clocking : clocking port map (
    ...
    hphone_valid <= AXIS_hphone_tvalid;
    ...
    begin  
       if (clk_100'event and clk_100 = '1') then
            ...
            AXIS_line_in_tvalid <= new_sample_100;                         -- additional FF for signal delay (alignment to data)
    ...
    begin  
       if (clk_100'event and clk_100 = '1') then
            if (hphone_valid = '1') then
                hphone_l_freeze_100 <= AXIS_hphone_tdata(23 downto 0);
                hphone_r_freeze_100 <= AXIS_hphone_tdata(47 downto 24);
            end if; 
       end if;
    end process;  
    ...
    begin  
       if (clk_100'event and clk_100 = '1') then
            if (new_sample_100 = '1') then
                AXIS_line_in_tdata(23 downto 0)  <= line_in_l_freeze_48;
                AXIS_line_in_tdata(47 downto 24) <= line_in_r_freeze_48;
            end if; 
       end if;
    end process;   
